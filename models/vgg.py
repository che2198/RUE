...
# 
# 
# def vgg11_bn(out_channels=10):
#     """VGG 11-layer model (configuration "A") with batch normalization"""
#     return VGG(make_layers(cfg['A'], batch_norm=True), out_channels)
# 
# 
...
# 
# 
# def vgg19_bn(out_channels=10):
#     """VGG 19-layer model (configuration 'E') with batch normalization"""
#     return VGG(make_layers(cfg['E'], batch_norm=True), out_channels)
